...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.7\textwidth]{chap/02-theory/img/adc/ideal_adc}
...
Even an ideal $N$-bit converter has errors resulting from the quantization process which can be modeled like noise. %todo maybe can be modelled as noise, or shows as noise instead of behave
...
\begin{figure}[tbh]
	...
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{chap/02-theory/img/adc/jitterTimeDomain.tikz}  
