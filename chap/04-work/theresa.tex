...
\autoref{v_conn} shows a V connector in male and female type.
\begin{figure}[tbh]
	\centering
	\begin{subfigure}{0.4\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{chap/04-work/img/v_m}  
	...
	\begin{subfigure}{0.4\textwidth}
		\centering
		\includegraphics[height=0.8\textwidth]{chap/04-work/img/v_f}  
...
This is important, as the regulator for the digital components should be separated from the analog part of the \gls{pcb}. 
...
Heat sinks could be added later during operation, if the deployed method
