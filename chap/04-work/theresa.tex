...
\subsection{\gls{pcb} Substrate Selection and }
TODO
...
The only parameters, which are not defined by the manufacturing process and therefore can be altered, are the ground strip separation $d$ and the trace width $a$. %todo always restate the physical symbols defined earlier
