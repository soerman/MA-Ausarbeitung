...
\begin{figure}[tb]
	...
	\caption[Aliasing]{Analog signal with frequency $f_a$ sampled at $f_s$ respecting (\autoref{fig:sampling}) and not respecting (\autoref{fig:alias_f}) the Nyquist criteria. \autoref{fig:alias_t} shows the effect of aliasing in time domain. \cite{walt}}
	\label{fig:alias}
\end{figure}
