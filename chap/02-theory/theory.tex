...
\\[4ex]
	\begin{subfigure}{\textwidth}
		...
		\caption{Working principle of a THA}
		\label{fig:tha_up}
	\end{subfigure}
...
\begin{figure}[tb]
	...
	\begin{subfigure}{\textwidth}
		...
		\label{fig:sjnr}
	\end{subfigure}
	\caption[Aperture jitter and SJNR]{Effects of aperture jitter on the output voltage and SJNR. Top: In time domain, Bottom: SJNR for different aperture jitter \cite{Lundberg}}
	\label{fig:ap_jit}
\end{figure}
