...
Formulas to calculate the characteristic impedance are quite complex and not easy to solve.
...
\begin{figure}[tb]
	...
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{chap/04-theresa/img/pcb/front}  
		\caption{Top side}
		\label{fig:pcb_front}
	\end{subfigure}
	\begin{subfigure}{\textwidth}
