...
\begin{document}
    ...
    \chapter{Terabit Sampling System for Photonics Time-Stretch/Photonic time-stretch data acquisition system}
    		\input{./chap/02-theory/system}
   	\chapter{State Of The Art Read-Out-Systems}
   	%		\input{./chap/03-currentStat/state}
   	...
   	\chapter{Readout Card - Xilinx ZCU216}
   			\input{./chap/04-work/zcu216}
   	\chapter{Firmware}
   			\input{./chap/04-work/firmware}			
	%\chapter{Characterization}	
	%		\input{./chap/05-characterization/characterization}
